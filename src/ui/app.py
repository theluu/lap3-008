...
- Kết quả: tìm đúng cả query có/không dấu
    ...
    with tab_chat:
        ...
        # Đọc provider/model từ session_state (được lưu bởi selectbox key)
        ...
        # Chat input — cập nhật state trước khi sidebar render
        ...
        with st.sidebar:
            ...
            st.caption(f"Đang dùng: `{selected_model}`")
